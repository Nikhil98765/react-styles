...
// * Follow the $<prop> convention inside the styled components to avoid clashing with built-in props 
...
export default function CustomFunction({ label, invalid, ...forwardedProps }) {
